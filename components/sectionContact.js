    ...
    <div class="wrap">
        ...
        <form class="Contact-form gform" @submit="submitForm" action="https://docs.google.com/forms/d/e/1FAIpQLSfN--Lqa4pyV6veTMT3L3ay7JF3jg7N6mR2O35pI9H5qY8XuA/formResponse?embedded=true" method="POST" target="hidden_iframe">        
            <div class="Contact-form__name">
                ...
                <div><input id="gfrm_name" type="text" name="entry.646620276" placeholder="Your Name" required></div>
            </div>
            <div class="Contact-form__email">
                <label for="gfrm_eml">E-mail: </label>
                <div><input id="gfrm_eml" type="email" name="emailAddress" placeholder="Your E-mail" required></div>
            </div>
            ...
            <div class="Contact-form__message">           
                ...
                <div><textarea id="gfrm_msg" name="entry.1283908172" placeholder="Enter text..." rows="3"></textarea></div>
            </div>
